...
<tr>
<td style="padding: 5px 10px; border-bottom: 1px solid black; border-right: 1px solid black">Aliasing</td>
...
<tr>
<td style="padding: 5px 10px; border-bottom: 1px solid black; border-right: 1px solid black">Threads<br> </td>
...
<td style="padding: 5px 10px; border-bottom: 1px solid black; text-align: left;"></td>
<td style="padding: 5px 10px; border-bottom: 1px solid black; border-left: 1px solid black; text-align: right;">Yielding<br><code class="remark-inline-code"><em>unyielding</em> < yielding</code></td>
</tr>
<tr>
<td style="padding: 5px 10px;">Purity</td>
<td style="padding: 5px 10px; border-right: 1px solid black; border-left: 1px solid black; text-align: left;">Visibility <br> <code class="remark-inline-code"><em>read_write</em> < read < immutable</code> </td>
<td style="padding: 5px 10px; text-align: right;">Statefulness <br> <code class="remark-inline-code">stateless < observing < <em>stateful</em></code></td>
</tr>
</tbody>
</table>
</div>
